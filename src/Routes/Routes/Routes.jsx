...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            
            {
                ...
                {
                    path: '/profile34',
                    element: <PrivateRoute><Profile34></Profile34></PrivateRoute>
                },
...

                {
                    ...
                    loader: ({params})=> fetch(`social-media-world-server-nuhwx57e6-nazmulhasan8s-projects.vercel.app/allProducts2/${params.id}`)
                  },
           
            {
                path: '/:id',
                element:<AllProducts></AllProducts>,
                loader: ({params}) => fetch(`social-media-world-server-nuhwx57e6-nazmulhasan8s-projects.vercel.app/allProducts/${params.id}`)
            },
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({params}) => fetch(`social-media-world-server-nuhwx57e6-nazmulhasan8s-projects.vercel.app/bookingsProduct/${params.id}`)
            },
        ]
    }
])
